...
public class Database  extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table JOURNEY( id integer primary key ,name text not null, dateFrom date not null, dateTo date not null);";
